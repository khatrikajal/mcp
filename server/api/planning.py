...
from server.database.models import User, ExecutionPlan, ApprovalRequest
from server.api.auth_utils import get_current_active_user
from server.services.planning_service import PlanningService
...
def cancel_execution_plan(
    ...
    from server.database.models import PlanStatus
